...
<p>Y aunque hoy los sets “naturales” montados en studio siguen siendo utilizados en la cinematografía para obtener primeros planos de tomas increíbles, afortunadamente, la crueldad deliberada hacia los animales se ha vuelto algo inaceptable e ilegal, el público exige que se le informe cuando las tomas son hechas en sets artificiales, y por lo menos, en México y los EEUU y México, gracias a organizaciones como el American Humain Association, (https://www.americanhumane.org/program/humane-hollywood/) los cineastas estamos obligados, al menos en el set, a tratar a los animales actores con respeto y dignidad.</p>
